...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 21 "ex_1pr.y" /* yacc.c:1646  */
    {
				(yyval.no) = (yyvsp[0].no);
				print_prefix((yyvsp[-1].no));
				exit(1);
			}
